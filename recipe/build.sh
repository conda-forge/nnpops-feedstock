...
if [ ${cuda_compiler_version} != "None" ]; then
    # Output format from torch._C._cuda_getArchFlags():
    # ['sm_35 sm_50 sm_60 sm_61 sm_70 sm_75 sm_80 sm_86 compute_86']
    # We need to turn this into: "3.5;5.0;6.0;6.1;7.0;7.5;8.0;8.6" for pytorch in CMake
